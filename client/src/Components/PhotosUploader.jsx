...
const PhotosUploader = ({ addedPhotos, setAddedPhotos }) => {
  ...
  const setThumbnail = (e, fileName) =>{
    e.preventDefault()
    const newAddedPhotos = [fileName, ...addedPhotos.filter((file) => file !== fileName)]
          ...
          addedPhotos.map((link, index) => (
            <div key={index} className="h-32 flex relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 p-2 text-white bg-black bg-opacity-40 rounded-full"
              >
                <svg
              ...
              <button
                onClick={(e) => setThumbnail(e,link)}
                className="cursor-pointer absolute bottom-1 left-1 p-2 text-white bg-black bg-opacity-40 rounded-full"
              >
                {addedPhotos[0] === link && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
